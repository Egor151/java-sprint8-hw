...
public class KVServer {
    ...
    private void load(HttpExchange httpExchange) throws CustomException, IOException {
        ...
        try (httpExchange) {
            ...
            if ("GET".equals(httpExchange.getRequestMethod())) {
                ...
                if (data.get(key) == null) {
                    ...
                    throw new CustomException("Данные отсутствуют"); // Бросаем кастомное исключение
                }
